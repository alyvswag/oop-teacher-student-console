...
public class Database {
    ...
    public static void showTeacherLessonStudent(){
        ...
        System.out.println("Sagirdler: "); showDataStudent();
        System.out.println("-----");
    ...
    public static void showStudentTeachTeacher(){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Muellimler "); showDataTeacher();
        System.out.println("-----");
        System.out.print("Secdiyiniz muellimin id daxil edin: "); int indexT = scanner.nextInt();
